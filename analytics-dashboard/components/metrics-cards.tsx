  ...
  return (
    <div className="grid grid-cols-2 gap-2">
      {metrics.map((metric, index) => (
        <Card key={index} className=" bg-card border-border hover:shadow-sm transition-all duration-300 mb-1 mx-3">
          <CardContent className="p-2">
            ...
            <div>
              ...
              <div className="flex items-center justify-between">
                <p className="text-lg font-semibold text-card-foreground mb-0.5">{metric.value}</p>
